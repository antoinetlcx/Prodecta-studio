...
const sectors: Record<Sector, { label: string; sections: Section[] }> = {
  ...
  hotel: { label: "Hôtel / gîte", sections: [
    { title: "Découvrir", body: "Faites découvrir les chambres, les espaces communs et l'ambiance du séjour.", items: ["Chambres", "Petit-déjeuner", "Extérieurs"] },
  ...
  venue: { label: "Château / domaine", sections: [
    ...
    { title: "Infos", body: "Orientez le visiteur vers une demande claire avec les bonnes informations.", items: ["Capacité", "Hébergement", "Brochure"] },
  ] },
  restaurant: { label: "Restaurant", sections: [
    ...
    { title: "Menu", body: "Ajoutez vos menus, offres groupes ou lien de réservation.", items: ["Carte", "Brunch", "Réserver"] },
    { title: "Contact", body: "Horaires, adresse, accès et réseaux sociaux.", items: ["Horaires", "Adresse", "Instagram"] },
  ] },
  showroom: { label: "Showroom", sections: [
    { title: "Showroom", body: "Mettez en scène vos produits et vos univers de marque.", items: ["Collections", "Démonstration", "Rendez-vous"] },
    { title: "Contact", body: "Transformez l'exploration en lead qualifié.", items: ["Devis", "RDV", "Catalogue"] },
  ...
  realestate: { label: "Immobilier", sections: [
    ...
    { title: "Infos", body: "Ajoutez surface, prix, charges et points forts.", items: ["Surface", "DPE", "Localisation"] },
  ...
  return <div className="app-shell" style={{"--accent": project.primary} as React.CSSProperties}>
    ...
    {visible ? <>
      ...
      <div className="floating-nav">
        ...
        <button className="nav-action active">Vue libre</button><button className="nav-action">Vue 3D</button><button className="nav-action">Plan 2D</button><button className="nav-action">Partager</button><button className="nav-action">FR</button>
      </div>
